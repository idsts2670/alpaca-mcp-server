...
def cmd_init():
    ...
    if paper:
        ...
        trade_api_wss = "wss://api.alpaca.markets/stream"
        data_api_url = "https://data.alpaca.markets"
        stream_data_wss = "wss://stream.data.alpaca.markets/v2/iex"
    ...
    lines = [
        ...
        f"TRADE_API_URL={trade_api_url}",
        f"TRADE_API_WSS={trade_api_wss}",
        f"DATA_API_URL={data_api_url}",
        f"STREAM_DATA_WSS={stream_data_wss}",
        "",
    ]
    env_path.write_text("\n".join(lines))
